...
var ObjectConfigJsonStr = `
{
	...
	"system_settings": {
		...
		"attributes": {
			...
			"time_trigger_permissions_user":                    { "type": "string",   "optional": true, "default": "Shoreline"},
	...
	"docs": {
		...
		"attributes": {
			...
			"time_trigger_permissions_user":                    "System setting indicating the user who will consistently execute triggered notebooks.",
