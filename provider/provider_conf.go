...
var ObjectConfigJsonStr = `
{
	...
	"docs": {
		...
		"attributes": {
			...
			"end_date":                "Date time when the trigger condition stops being evaluted. If not provided, the condition is evaluated with no time limit. The accepted format is ISO8601.",
			...
			"start_date":              "Date time when the trigger condition starts being evaluated (default value is considered to be when the trigger configuration was saved). The accepted format is ISO8601.",
