...
var ObjectConfigJsonStr = `
{
	...
	"notebook": {
		"attributes": {
			...
			"cells":                   { "type": "b64json",    "optional": true, "step": "skip.param", "outtype": "json", "conflicts": ["data"], "default": "[]"},
			"params":                  { "type": "b64json",    "optional": true, "outtype": "json", "conflicts": ["data"], "match_null": "[]", "default": "[]"},
			"external_params":         { "type": "b64json",    "optional": true, "outtype": "json", "conflicts": ["data"], "match_null": "[]", "default": "[]"},
